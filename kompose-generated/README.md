...
Note: this chart is generated by
`.github/workflows/update-kompose-chart.yml` and published by
`.github/workflows/publish-chart.yml`. Do not hand-edit the generated
`templates/`; edit the generator or the upstream compose instead.
